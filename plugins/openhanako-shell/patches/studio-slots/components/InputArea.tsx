...
function InputAreaInner({ surface }: Required<InputAreaProps>) {
  ...
  const editor = useEditor({
    // Cold starts (desktop and mobile PWA) can race editor DOM creation with the first render.
    // Always create the editor after mount so RegionalErrorBoundary does not catch a first-paint throw.
