...
export function SettingsContent({
  ...
  // Reset scroll on tab change so leftover overflow doesn't flash a scrollbar.
  useEffect(() => {
      ...
      <div className={styles['settings-content-root']} data-input-ctx-zone="settings">
        ...
        >
          ...
          <div className={styles['settings-body']}>
            ...
            <div className={styles['settings-main-shell']}>
              {isModal && <div className={styles['settings-main-fade']} aria-hidden />}
              <div ref={mainRef} className={styles['settings-main']}>
                {!isModal && (
